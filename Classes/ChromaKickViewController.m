...
#import "ChromaKickViewController.h"

#import <QuartzCore/QuartzCore.h>
#import "ChromaKickCapturePipeline.h"
#import "OpenGLPixelBufferView.h"

@interface ChromaKickViewController () <ChromaKickCapturePipelineDelegate>
{
	...
	ChromaKickCapturePipeline *_capturePipeline;
}
...
@implementation ChromaKickViewController
...
- (void)viewDidLoad
{
	_capturePipeline = [[ChromaKickCapturePipeline alloc] initWithDelegate:self callbackQueue:dispatch_get_main_queue()];
...
#pragma mark - ChromaKickCapturePipelineDelegate
...
- (void)capturePipeline:(ChromaKickCapturePipeline *)capturePipeline recordingDidFailWithError:(NSError *)error
{
	[self recordingStopped];
	[self showError:error];
}
